...
def main():
    ...
    try:
        ...
        mode_reduntant = sys.argv[3]
        mode = int(sys.argv[4])
    except:
        if(len(sys.argv) < 4):
            print("USAGE:python3 main.py type(vid/img) PATH outputPATH")
            return 1
...
"""
        ...
        result = overlay(left_curvem,right_curvem, offset,result,bird_draw,slid_out,warped,lane_markings)    
